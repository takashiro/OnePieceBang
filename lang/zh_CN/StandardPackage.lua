...
作用效果：目标角色回复1点体力",
	...
	["busou_haki"] = "霸气·武装色",
	[":busou_haki"] = "基本牌\
出牌时机：1、出牌阶段；2、受到多于1点伤害时。\
使用目标：你\
作用效果：1、令自己的下一张使用的【杀】造成的伤害+1（每阶段限使用1次）；2、防止自己受到的伤害。",
	["#Drank"] = "%from 使用了【霸气·武装色】硬化，下一张【杀】将具有伤害 +1 的效果",
	["#UnsetDrank"] = "%from 杀的结算完毕，【霸气】的效果消失",
	["#UnsetDrankEndOfTurn"] = "%from 的回合结束，【霸气】的效果消失",
	["#BusouHakiBuff"] = "%from 使用了【%arg】，对 %to 造成的杀伤害 +1",
	["damage-busou-haki"] = "你将受到多于1点伤害，请使用【霸气·武装色】硬化",
	["#BusouHakiDefense"] = "%from 使用了【%arg】，防止了伤害",
...
出牌时机：目标效果对目标角色生效前。\
使用目标：目标效果。\
作用效果：抵消目标诡计牌对一名角色产生的效果，或抵消另一张【见闻色霸气】产生的效果",
...
出牌时机：出牌阶段。\
使用目标：你。\
作用效果：将【雷天候】放置于你判定区里，目标角色回合判定阶段，进行判定；若判定结果为黑桃2-9之间（包括黑桃2和9），则将【雷天候】置入弃牌堆，目标角色受到3点雷电伤害。若判定结果不为黑桃2-9之间（包括黑桃2和9），将【雷天候】移动到当前目标角色下家（【雷天候】的目标变为该角色）的判定区",

	["rain"] = "雨天候",
	[":rain"] = "延时诡计牌\
出牌时机：出牌阶段。\
使用目标：你。\
作用效果：将【雨天候】放置于你判定区里，目标角色回合判定阶段，进行判定；若判定结果为红桃2-9之间（包括红桃2和9），则将【雨天候】置入弃牌堆，目标角色回复1点体力，手牌区和判定区的红桃牌视为黑桃牌直到回合结束。若判定结果不为黑桃2-9之间（包括黑桃2和9），将【雨天候】移动到当前目标角色下家（【雨天候】的目标变为该角色）的判定区",
	["raineffect"] = "雨天候",
...
防具效果：<b>锁定技</b>，【海王类】、【万箭齐发】和普通【杀】对你无效。当你受到火焰伤害时，此伤害+1",
	...
	["diamond_armor"] = "钻石铠甲",
	[":diamond_armor"] = "装备牌·防具\
防具效果：<b>锁定技</b>，当你受到伤害时，若该伤害多于1点，则防止多余的伤害；当你失去装备区里的【钻石铠甲】时，你回复1点体力",
	["#DiamondArmor"] = "%from 的防具【%arg2】防止了 %arg 点伤害，减至1点",
