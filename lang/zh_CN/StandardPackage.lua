...
武器特效：当你使用的【杀】被【闪】抵消时，你可以立即对相同的目标再使用一张【杀】直到【杀】生效或你不愿意出了为止",
	["blade-slash"] = "您可以再打出一张【杀】发动鬼彻的追杀效果",
...
武器特效：<b>锁定技</b>，当你使用的【杀】被【闪】抵消时，你弃置两张牌或流失1点体力，然后此【杀】依然造成伤害",
	["@axe"] = "你可再弃置两张牌（包括装备）或流失1点体力使此杀强制命中",
	["#AxeSkill"] = "%from 使用了【%arg】的技能，对 %to 强制命中",
...
武器特效：<b>锁定技</b>，当你使用【杀】对目标角色造成伤害时，若其没有手牌，此伤害+1",
	["#GudingBladeEffect"] = "%from 装备的秋水生效，无手牌对象 %to 的伤害从 %arg 增加到 %arg2",
