...
return {
	...
	["wuhun"] = "武魂",
	[":wuhun"] = "<b>锁定技</b>，任意角色每对你造成1点伤害，获得一个梦魇标记，你死亡时，令持有最多该标记的一名角色判定，除非结果为【伤药】或【伤药园结义】，否则该角色立即死亡。",
	["@nightmare"] = "梦魇",
...
★大雾不能防止失去体力",
	...
	["longhun"] = "龙魂",
	[":longhun"] = "你可以将同花色的X张牌按下列规则使用（或打出）：红桃当【伤药】，方块当火属性的【杀】，梅花当【闪】，黑桃当【无懈可击】（X为你的当前体力值且至少为1）",
