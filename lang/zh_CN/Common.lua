return {
	...
	["#AskForVulneraries"] = "%from 向 %to 求救，一共需要 %arg 个【伤药】",
	["#ChooseKingdom"] = "%from 选择了 %arg 作为他的国籍",
	["#NullificationDetails"] = "无懈的对象是 %from 对 %to 的特技 %arg",
	...
	["#DelayedTrick"] = "%from 的延时特技【%arg】开始判定",
	...
	["cw"] = "顺时针",
	["ccw"] = "逆时针",
	["#TrickDirection"] = "%from 选择了 %arg 作为特技的顺序",
	["custom"] = "自定义模式",
	["UnknowNick"] = "无称号",
