return {
	...
	["Scene7"] = "无计可施",
	["Scene7Effect"] = "本轮所有非延时性特技无效",
	["#Scene7CardInvalid"] = "无计可施的场景效果被触发，%from 使用的特技无效。",
	["Scene8"] = "知己知彼",
	...
	["Scene15"] = "落井下石",
	["Scene15Effect"] = "本轮当有角色受到用【杀】造成的无属性伤害时，该角色须选择弃置一张手牌或失去一点体力",
	["#Scene15NeedDiscard"] = "落井下石的场景效果被触发，%to 需要弃置一张手牌。",
	["Scene16"] = "舍己为人",
	["Scene16Effect"] = "本轮在出牌阶段对自己使用【伤药】无效，此时必须指定其他一名角色回复1点体力。",
	["#Scene16Recover"] = "舍己为人的场景效果被触发，%from 指定 %to 回复了1点体力。",
	["Scene17"] = "李代伤药僵",
	["Scene17Effect"] = "本轮有角色受到伤害时，该伤害将被防止，且该角色的下家失去与该伤害同点数的体力值",
	["#Scene17NoDamage"] = "李代伤药僵的场景效果被触发，%to 受到的伤害无效。",
	...
	["Scene28Effect"] = "无效果",
	["Scene29"] = "单打独斗",
	["Scene29Effect"] = "当此场景生效时，若一名角色和其下家均有手牌则该角色须对下家进行一次拼点。赢则选择让对方回复一点体力或弃置一张牌，没赢则对方选择让你回复一点体力或弃置一张牌。弃牌时无手牌则失去一点体力",
